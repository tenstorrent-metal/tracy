...
int main( int argc, char** argv )
{
    ...
    char hdr_filename[1024];
    snprintf(hdr_filename, sizeof(hdr_filename), "%s.hpp", destination);
    FILE* hdr = fopen( hdr_filename, "wb" );
    ...
    char cpp_filename[1024];
    snprintf(cpp_filename, sizeof(cpp_filename), "%s.cpp", destination);
    FILE* cpp = fopen( cpp_filename, "wb" );
